...
- analyses
    ...
    - 05R_calculations
      - Each of the directories in analyses/ contains a markdown document called "labnotebook_etc.Rmd". This file includes a description of the analysis being performed, the most recent workflow to run this analysis, and my notes from previous testing. You'll also find the shell executable and submit scripts, lists of the samples run, and small input/output files.
