...
Run the kraken submit and executable here. We're only classifying right now - we'll make the human readable report in the next step.
...
./kraken-report --db ../../minikraken_20141208/ ../../$1.output > ../../$1_kraken.report
cd ../..

#Remove spaces in the 6th column of the kraken report
awk '{gsub(" ","",$6)}1' $1.report > temp.txt && mv temp.txt $1.report
