...
rsync -av amlinz@submit-3.chtc.wisc.edu:/mnt/gluster/amlinz/GEODES_nonrRNA_concat/ GEODES_nonrRNA 
rsync -av amlinz@submit-3.chtc.wisc.edu:/mnt/gluster/amlinz/GEODES_rRNA_concat/ GEODES_rRNA 
```
...
for num in $startpoints;
  ...
  bbmap/getreads.sh in=$1.filter-MTF.fastq id=$num-$endpoint out=$1.filter-MTF_$endpoint.fastq overwrite=T;
  done
