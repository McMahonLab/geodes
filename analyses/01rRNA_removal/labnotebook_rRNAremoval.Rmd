...
when_to_transfer_output = ON_EXIT
transfer_input_files = zipped/BBMap_36.99.tar.gz
transfer_output_files = $(samplename)*.gz
...
find /home/amlinz/GEODES_metaT_split/ -type f > path2splitfastqs.txt
```
...
#!/bin/bash
#Concatenate sortmerna output
mv *_rRNA.fastq.gz /home/amlinz/GEODES_rRNA_split
mv *nonrRNA.fastq.gz /home/amlinz/GEODES_nonrRNA_split

gzip -d /home/amlinz/GEODES_rRNA_split
gzip -d /home/amlinz/GEODES_nonrRNA_split

for sample in /home/amlinz/samplenames.txt;
  do $(sample)*_nonrRNA.fastq > /mnt/gluster/amlinz/GEODES_nonrRNA/$(sample)_nonrRNA.fastq;
  $(sample)*_rRNA.fastq > /mnt/gluster/amlinz/GEODES_rRNA/$(sample)_rRNA.fastq;
  done
