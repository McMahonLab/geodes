...
pathway.stats <- function(searchterm){
  ...
  report <- c(numgenes, round(percent_genes_day, 2), round(percent_reads_day, 2), round(percent_genes_night, 2), round(percent_reads_night, 2), round(percent_cyclic_genes, 2), round(percent_cyclic_reads, 2), formatC(mean(day_totals), format = "e", digits = 2), formatC(mean(night_totals), format = "e", digits = 2), round(sig$p.value, 2))
...
|                         | % Number of genes | % Genes more expressed in day      | % Reads in day contributed by those genes                | % Genes more expressed at night   | % Reads at night contributed by those genes | % Cyclic genes (12 hr phase) | % Reads contributed by cyclic genes | Mean reads in day samples | Mean reads in night samples | p-value from t-test of day vs. night read totals |
| ----------------------- |:-----------------:|:------------------------:|:------------------------:|:------------------------:|:------------------------:|:------------------------:|:------------------------:|:------------------------:|:------------------------:|
| Photosynthesis | `r photo[1]` | `r photo[2]` | `r photo[3]` | `r photo[4]` | `r photo[5]` | `r photo[6]` | `r photo[7]` | `r photo[8]` | `r photo[9]`| `r photo[10]`|
| Rhodopsins | `r rhodo[1]` | `r rhodo[2]` | `r rhodo[3]` | `r rhodo[4]` | `r rhodo[5]` | `r rhodo[6]` | `r rhodo[7]` | `r rhodo[8]` | `r rhodo[9]`| `r rhodo[10]`|
| RuBisCO | `r rubisco[1]` | `r rubisco[2]` | `r rubisco[3]` | `r rubisco[4]` | `r rubisco[5]` | `r rubisco[6]` | `r rubisco[7]` | `r rubisco[8]` | `r rubisco[9]` |`r rubisco[10]` |
| reductive TCA | `r rTCA[1]` | `r rTCA[2]` | `r rTCA[3]` | `r rTCA[4]` | `r rTCA[5]` | `r rubisco[6]` | `r rTCA[7]` | `r rTCA[8]` | `r rTCA[9]` | `r rTCA[10]` |
| Nitrogenase | `r nif[1]` | `r nif[2]` | `r nif[3]` | `r nif[4]` | `r nif[5]` | `r nif[6]` | `r nif[7]` | `r nif[8]` | `r nif[9]` | `r nif[10]` |
| Polyamines | `r polyamines[1]` | `r polyamines[2]` | `r polyamines[3]` | `r polyamines[4]` | `r polyamines[5]` | `r polyamines[6]` | `r polyamines[7]` | `r polyamines[8]` | `r polyamines[9]` |`r polyamines[10]` |
| Chitinase | `r chitinase[1]` | `r chitinase[2]` | `r chitinase[3]` | `r chitinase[4]` | `r chitinase[5]` | `r chitinase[6]` | `r chitinase[7]` | `r chitinase[8]` | `r chitinase[9]` |`r chitinase[10]` |
| Alkaline phosphatase | `r ap[1]` | `r ap[2]` | `r ap[3]` | `r ap[4]` | `r ap[5]` | `r ap[6]` | `r ap[7]` | `r ap[8]` | `r ap[9]` || `r ap[10]` |
| Cellulase | `r cellulase[1]` | `r cellulase[2]` | `r cellulase[3]` | `r cellulase[4]` | `r cellulase[5]` | `r cellulase[6]` | `r cellulase[7]` | `r cellulase[8]` | `r cellulase[9]` |`r cellulase[10]` |
| Reactive oxygen species | `r ros[1]` | `r ros[2]` | `r ros[3]` | `r ros[4]` | `r ros[5]` | `r ros[6]` | `r ros[7]` | `r ros[8]` | `r ros[9]` | `r ros[10]` |
| Nitrite reduction | `r nitrite_reduction[1]` | `r nitrite_reduction[2]` | `r nitrite_reduction[3]` | `r nitrite_reduction[4]` | `r nitrite_reduction[5]` | `r nitrite_reduction[6]` | `r nitrite_reduction[7]` | `r nitrite_reduction[8]` | `r nitrite_reduction[9]` |`r nitrite_reduction[10]` |
| Protease | `r protease[1]` | `r protease[2]` | `r protease[3]` | `r protease[4]` | `r protease[5]` | `r protease[6]` | `r protease[7]` | `r protease[8]` | `r protease[9]` | `r protease[10]` 
| Carboxylate transport | `r carbox[1]` | `r carbox[2]` | `r carbox[3]` | `r carbox[4]` | `r carbox[5]` | `r carbox[6]` | `r carbox[7]` | `r carbox[8]` | `r carbox[9]` | `r carbox[10]` |
| Ribose transport | `r ribose[1]` | `r ribose[2]` | `r ribose[3]` | `r ribose[4]` | `r ribose[5]` | `r ribose[6]` | `r ribose[7]` | `r ribose[8]` | `r ribose[9]` | `r ribose[10]` |
| General sugar transport | `r gen.sugars[1]` | `r gen.sugars[2]` | `r gen.sugars[3]` | `r gen.sugars[4]` | `r gen.sugars[5]` | `r gen.sugars[6]` | `r gen.sugars[7]` | `r gen.sugars[8]` | `r gen.sugars[9]` | `r gen.sugars[10]` |
| Raffinose/stachyose/melibiose transport | `r raff[1]` | `r raff[2]` | `r raff[3]` | `r raff[4]` | `r raff[5]` | `r raff[6]` | `r raff[7]` | `r raff[8]` | `r raff[9]` |
| Glucose/mannose transport | `r gluc[1]` | `r gluc[2]` | `r gluc[3]` | `r gluc[4]` | `r gluc[5]` | `r gluc[6]` | `r gluc[7]` | `r gluc[8]` | `r gluc[9]` | `r gluc[10]` |
| Rhamnose transport | `r rham[1]` | `r rham[2]` | `r rham[3]` | `r rham[4]` | `r rham[5]` | `r rham[6]` | `r rham[7]` | `r rham[8]` | `r rham[9]` | `r rham[10]` |
| Xylose transport | `r xyl[1]` | `r xyl[2]` | `r xyl[3]` | `r xyl[4]` | `r xyl[5]` | `r xyl[6]` | `r xyl[7]` | `r xyl[8]` | `r xyl[9]` |`r xyl[10]` |
| Fructose transport | `r fruct[1]` | `r fruct[2]` | `r fruct[3]` | `r fruct[4]` | `r fruct[5]` | `r fruct[6]` | `r fruct[7]` | `r fruct[8]` | `r fruct[9]` | `r fruct[10]` |
| Chitobiose transport | `r chiti[1]` | `r chiti[2]` | `r chiti[3]` | `r chiti[4]` | `r chiti[5]` | `r chiti[6]` | `r chiti[7]` | `r chiti[8]` | `r chiti[9]` | `r chiti[10]` |
| Lactose/arabinose transport | `r lact[1]` | `r lact[2]` | `r lact[3]` | `r lact[4]` | `r lact[5]` | `r lact[6]` | `r lact[7]` | `r lact[8]` | `r lact[9]` | `r lact[10]` |
...
| RuBisCO | `r rubisco[1]` | `r rubisco[2]` | `r rubisco[3]` | `r rubisco[4]` | `r rubisco[5]` | `r rubisco[6]` | `r rubisco[7]` | `r rubisco[8]` | `r rubisco[9]` | `r rubisco[10]` |
| reductive TCA | `r rTCA[1]` | `r rTCA[2]` | `r rTCA[3]` | `r rTCA[4]` | `r rTCA[5]` | `r rubisco[6]` | `r rTCA[7]` | `r rTCA[8]` | `r rTCA[9]` | `r rTCA[10]` |
| Glycoside hydrolases | `r gh[1]` | `r gh[2]` | `r gh[3]` | `r gh[4]` | `r gh[5]` | `r gh[6]` | `r gh[7]` | `r gh[8]` | `r gh[9]` | `r gh[10]` |
| Polyamines | `r polyamines[1]` | `r polyamines[2]` | `r polyamines[3]` | `r polyamines[4]` | `r polyamines[5]` | `r polyamines[6]` | `r polyamines[7]` | `r polyamines[8]` | `r polyamines[9]` | `r polyamines[10]` |
| Chitinase | `r chitinase[1]` | `r chitinase[2]` | `r chitinase[3]` | `r chitinase[4]` | `r chitinase[5]` | `r chitinase[6]` | `r chitinase[7]` | `r chitinase[8]` | `r chitinase[9]` | `r chitinase[10]` |
| Alkaline phosphatase | `r ap[1]` | `r ap[2]` | `r ap[3]` | `r ap[4]` | `r ap[5]` | `r ap[6]` | `r ap[7]` | `r ap[8]` | `r ap[9]` | `r ap[10]` |
| Cellulase | `r cellulase[1]` | `r cellulase[2]` | `r cellulase[3]` | `r cellulase[4]` | `r cellulase[5]` | `r cellulase[6]` | `r cellulase[7]` | `r cellulase[8]` | `r cellulase[9]` | `r cellulase[10]` |
...
| Xylose transport | `r xyl[1]` | `r xyl[2]` | `r xyl[3]` | `r xyl[4]` | `r xyl[5]` | `r xyl[6]` | `r xyl[7]` | `r xyl[8]` | `r xyl[9]` | `r xyl[10]` |
| Fructose transport | `r fruct[1]` | `r fruct[2]` | `r fruct[3]` | `r fruct[4]` | `r fruct[5]` | `r fruct[6]` | `r fruct[7]` | `r fruct[8]` | `r fruct[9]` | `r fruct[10]` |
| Methane/ammonia monooxygenase | `r meth[1]` | `r meth[2]` | `r meth[3]` | `r meth[4]` | `r meth[5]` | `r meth[6]` | `r meth[7]` | `r meth[8]` | `r meth[9]` | `r meth[10]` |
| Urease | `r urea[1]` | `r urea[2]` | `r urea[3]` | `r urea[4]` | `r urea[5]` | `r urea[6]` | `r urea[7]` | `r urea[8]` | `r urea[9]` | `r urea[10]` |
...
| Ribose transport | `r ribose[1]` | `r ribose[2]` | `r ribose[3]` | `r ribose[4]` | `r ribose[5]` | `r ribose[6]` | `r ribose[7]` | `r ribose[8]` | `r ribose[9]` | `r ribose[10]` |
| General sugar transport | `r gen.sugars[1]` | `r gen.sugars[2]` | `r gen.sugars[3]` | `r gen.sugars[4]` | `r gen.sugars[5]` | `r gen.sugars[6]` | `r gen.sugars[7]` | `r gen.sugars[8]` | `r gen.sugars[9]` | `r gen.sugars[10]` |
| Raffinose/stachyose/melibiose transport | `r raff[1]` | `r raff[2]` | `r raff[3]` | `r raff[4]` | `r raff[5]` | `r raff[6]` | `r raff[7]` | `r raff[8]` | `r raff[9]` | `r raff[10]` |
| Glucose/mannose transport | `r gluc[1]` | `r gluc[2]` | `r gluc[3]` | `r gluc[4]` | `r gluc[5]` | `r gluc[6]` | `r gluc[7]` | `r gluc[8]` | `r gluc[9]` | `r gluc[10]` |
| Rhamnose transport | `r rham[1]` | `r rham[2]` | `r rham[3]` | `r rham[4]` | `r rham[5]` | `r rham[6]` | `r rham[7]` | `r rham[8]` | `r rham[9]` | `r rham[10]` |
| Xylose transport | `r xyl[1]` | `r xyl[2]` | `r xyl[3]` | `r xyl[4]` | `r xyl[5]` | `r xyl[6]` | `r xyl[7]` | `r xyl[8]` | `r xyl[9]` | `r xyl[10]` |
| Fructose transport | `r fruct[1]` | `r fruct[2]` | `r fruct[3]` | `r fruct[4]` | `r fruct[5]` | `r fruct[6]` | `r fruct[7]` | `r fruct[8]` | `r fruct[9]` | `r fruct[10]` |
