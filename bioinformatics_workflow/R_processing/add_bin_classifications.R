...
# 
# write.csv(mendota_key, "D:/geodes_data_tables/Mendota_ID90_genekey_reclassified.csv", row.names = F)
...
# 
# write.csv(spark_key, "D:/geodes_data_tables/Sparkling_ID90_genekey_reclassified.csv", row.names = F)
...
write.csv(trout_key, "D:/geodes_data_tables/Trout_ID90_genekey_reclassified.csv", row.names = F)
