...
condor_submit submits/05.1metaG_gffs.sh
condor_submit submits/05.2metaG_gffs.sh
condor_submit submits/05.3metaG_gffs.sh
condor_submit submits/05.4metaG_gffs.sh
condor_submit submits/05.5metaG_gffs.sh
condor_submit submits/05.6metaG_gffs.sh
condor_submit submits/05.7metaG_gffs.sh
condor_submit submits/05.8metaG_gffs.sh
condor_submit submits/05.9metaG_gffs.sh
condor_submit submits/05.10metaG_gffs.sh
./scripts/move_CDS_output.sh
condor_submit submits/06cd-hit.sub
# Note: can start the mapping now
# calculate max size to include in 07nrdb_gff.sh
