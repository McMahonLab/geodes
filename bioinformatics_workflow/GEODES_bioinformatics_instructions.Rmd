...
./scripts/make_table.sh
gzip GEODES_ID75_2017-12-17.txt
#make sure to modify filenames in genekey.py before submitting
condor_submit submits/11table_processing.sub
